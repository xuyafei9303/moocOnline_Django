...
class Course(models.Model):
    ...
    detail = UEditorField(verbose_name=u"课程详情",
                                         ...
                                         imagePath="course/ueditor/",# 上传图片存储路径
    ...
    def go_to(self):
        from django.utils.safestring import mark_safe# 解析文本 显示样式 不显示源代码
        return mark_safe("<a href='https://baidu.com'>跳转</>")
    get_zj_nums.short_description = u"跳转"
...
class BannerCourse(Course):
    class Meta:
        verbose_name = "轮播课程"
        verbose_name_plural = verbose_name
        proxy = True # 一个model管理多张表 这个字段是一定要设置的
